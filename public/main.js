            ...
            */
            ...
            if (!sessionData) {
                ...
                _this.getProjectState().then(function (data) {
                    ...
                    .then(function (data) {
                    var fileName = _this.userState['username'] + "/" + projectState_1.name + "/thumbnail";
                    return _this.uploadDataUrlToFirebase(_this.userState['token'], data, fileName);
                })
                    .then(function (res) {
                    var uploadData = res;
